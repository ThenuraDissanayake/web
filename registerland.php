    ...
    <div class="container-01">
        ...
        <div class="form-box" id="logbox01">
            ...
            <form id="register01" class="input-group" action="" method="post">
                <input type="text" class="input-field" placeholder="Enter your Name" id="textcolor1" name="User_Name" />
                ...
                <h5 id="text0010">Already have an account? <a href="login.html"> Login now</a></h5>
            </form>
